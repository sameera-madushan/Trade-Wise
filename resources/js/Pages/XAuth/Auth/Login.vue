				...
				<div class="row justify-content-center form-bg-image">
					<div class="col-12 d-flex align-items-center justify-content-center">
						<div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
							...
							<div v-if="status" class="fw-normal text-sm text-success">
								{{ status }}
							</div>
							<form class="mt-4" @submit.prevent="submit">
								...
								<div class="form-group">
									...
									<div class="d-flex justify-content-between align-items-top mb-4">
										...
										<div><Link v-if="canResetPassword" :href="route('password.request')" class="small text-right">Lost password?</Link></div>
									</div>
								</div>
								<div class="d-grid">
									<LoadingButton type="submit" class="btn btn-gray-800" :is-loading="form.processing" :disabled="form.processing">Sign in</LoadingButton>
								</div>
							</form>
